...
// On Vercel (single-project Services setup) the frontend and backend share
// one domain, and the root vercel.json rewrites /api/* to the backend
// service — so a relative path avoids CORS entirely. Locally, where
// frontend (5173) and backend (5000) are different origins, fall back to
// an absolute URL via VITE_API_URL.
